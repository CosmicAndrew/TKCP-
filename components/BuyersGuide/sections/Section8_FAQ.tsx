...
const Section8_FAQ: React.FC<{ sector: Sector; result: Result; }> = ({ sector }) => {
    ...
    return (
        <div className="animate-fade-in-up">
            <h2 className="text-3xl font-display font-bold text-gray-800 dark:text-gray-100">8. Frequently Asked Questions</h2>

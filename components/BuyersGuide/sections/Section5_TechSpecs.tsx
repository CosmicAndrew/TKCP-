...
const Section5_TechSpecs: React.FC<SectionProps> = ({ sector }) => {
    ...
    return (
        <div className="animate-fade-in-up">
            <h2 className="text-3xl font-display font-bold text-gray-800 dark:text-gray-100">5. Technical Specifications</h2>
...
export default Section5_TechSpecs;

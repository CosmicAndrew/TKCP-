...
const Section7_Process: React.FC<SectionProps> = ({ sector }) => {
    const steps = [
    ...
    return (
        <div className="animate-fade-in-up">
            <h2 className="text-3xl font-display font-bold text-gray-800 dark:text-gray-100">7. The TKCP Implementation Process</h2>
...
export default Section7_Process;

...
const Confirmation: React.FC<ConfirmationProps> = ({ result, onReset, sector }) => {
    ...
    const handleShare = async () => {
        ...
        const shareData = {
            ...
            text: `I just took the TKCP LED Assessment and scored ${score}/${maxScore}! Check out my results and take the assessment yourself.`,
            url: resultsUrl,
        };
        try {
            if (navigator.share) {
        ...
        <div className="max-w-4xl mx-auto text-center animate-fade-in relative overflow-hidden rounded-lg">
            ...
            <div className="bg-white/80 dark:bg-gray-800/90 backdrop-blur-sm rounded-lg shadow-2xl p-8 md:p-12 relative z-10">
                ...
                <div className="mt-12 flex items-center justify-center gap-6">
                    ...
                    <button onClick={handleShare} className="text-gray-500 hover:text-gray-800 dark:text-gray-400 dark:hover:text-gray-200 font-semibold flex items-center mx-auto transition-colors text-sm">

...
const Confirmation: React.FC<ConfirmationProps> = ({ result, onReset, sector }) => {
    ...
    return (
        <div className="max-w-3xl mx-auto text-center animate-fade-in relative">
            <Confetti />
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow-2xl p-8 md:p-12 relative z-10">
                ...
                {geminiInsights && (
                    <div className={`mt-8 text-left bg-gray-50 dark:bg-gray-700/50 p-6 rounded-lg border dark:border-gray-700 ${
                        (leadStatus === 'hot' || leadStatus === 'warm') ? 'animate-scale-in-subtle' : 'animate-fade-in-up'
                    }`}>
                        <h3 className="text-xl font-display font-bold text-gray-800 dark:text-gray-100 text-center mb-4">Your Personalized Insights</h3>
                        <p className="text-gray-700 dark:text-gray-300 text-center">{geminiInsights.summary}</p>
                        <h4 className="font-bold text-gray-700 dark:text-gray-200 mt-6 mb-2 text-center">Your Actionable Next Steps:</h4>
                        <ul className="space-y-2 max-w-md mx-auto text-gray-600 dark:text-gray-300">
                ...
                <div className="mt-10 border-t dark:border-gray-700 pt-8">
                    <h3 className="text-2xl font-display font-bold dark:text-gray-100">Can't Wait?</h3>
                    <p className="text-gray-600 dark:text-gray-300 mt-2">Feel free to reach out to us directly or share your results.</p>
                    <div className="mt-6 flex flex-col sm:flex-row flex-wrap justify-center gap-4">
                        ...
                        <a href="tel:+14698409808" className="flex items-center justify-center w-full sm:w-auto px-8 py-3 font-bold text-gray-900 rounded-md bg-church-accent hover:bg-yellow-400 transition-colors">
                            <IconPhone className="w-5 h-5" />
                            <span className="ml-2">Call Us Directly</span>
                        </a>
                        <button onClick={handleShare} className="flex items-center justify-center w-full sm:w-auto px-8 py-3 font-bold text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300 transition-colors dark:bg-gray-600 dark:text-gray-200 dark:hover:bg-gray-500">
